...
// unsigned int crc_calc(unsigned int cnt, unsigned char *buf);
// lookup table for crc 32
const unsigned int crc32_tbl[256]={
...
unsigned int crc_calc(unsigned int cnt, unsigned char *buf) {
    ...
    unsigned int calc_crc = 0x00000000;  // Use the input crc value
